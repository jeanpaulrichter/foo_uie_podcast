...
namespace ui_extension{
	...
	*/
	...
	{
	public:
		window_factory() : service_factory_base(window::class_guid, service_factory_traits<T>::factory_list())
		{
		}
	...
	*/
	...
	public:
		window_factory_single() : service_factory_base(window::class_guid, service_factory_traits<T>::factory_list()) {}
	...
	*/
	...
	{	
	public:
		window_factory_transparent_single() : service_factory_base(window::class_guid, service_factory_traits<T>::factory_list()) {}
